@php
    ...
    $email = \App\Models\Setting::getValue('email', 'info@amarafood.com');
...
<footer class="bg-gray-900 text-white mt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- اللمحة التعريفية -->
            <div>
                <h3 class="text-xl font-bold mb-4">AmaraFood</h3>
                @if($companyOverview)
            ...
            <div>
                ...
                <div class="mt-6 flex space-x-reverse space-x-4">
                    ...
                    @endif
                    @if($twitter)
                        <a href="{{ $twitter }}" target="_blank" class="text-gray-400 hover:text-blue-400 transition">
                    ...
                    @endif
                    @if($whatsapp)
                        <a href="https://wa.me/{{ str_replace(['+', ' ', '-'], '', $whatsapp) }}" target="_blank" class="text-gray-400 hover:text-green-500 transition">
