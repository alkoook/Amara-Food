...
<div class="mb-6 flex justify-between items-center">
        <h3 class="text-2xl font-bold text-gray-800">{{ __('Brands') }}</h3>
        <a href="{{ route('admin.brands.create') }}" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg">
           {{ __('Add a New Brand') }}
        </a>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="mb-4">
            <input type="text" wire:model.live="search" placeholder="{{ __('Search With Brand Name') }}..."
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <button wire:click="delete({{ $brand->id }})"
                                        wire:confirm="{{ __('Are You Sure You Want to Delete This Brand') }}"
