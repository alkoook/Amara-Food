...
<div class="mb-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 max-w-4xl">
        <div class="flex justify-between items-start mb-6">
            <h3 class="text-2xl font-bold text-gray-800"> {{ __("Product Details") }}</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1"> {{ __("Product Name") }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">{{ __("Brand") }}</label>
                ...
                @if($product->quantity)
                    <div>
                        <label class="block text-sm font-medium text-gray-500 mb-1">{{ __('Quantity') }}</label>
                        <p class="text-gray-900">{{ $product->quantity }} </p>
                    </div>
                @endif

                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">{{ __('Added Date') }}</label>
